...
101       continue
  ...
  SUBROUTINE fill_plintab(iz,cosm,CAMB_PK)
    ...
    REAL, PARAMETER :: pi=3.141592654
    INTEGER, PARAMETER :: imeth=2 !Fix the method for filling linear power tables
  ...
  SUBROUTINE halomod_init(z,lut,cosm)
    ...
    INTEGER, PARAMETER :: n=256 !Number of entries in look-up HM_tables. Could be played with to improve speed or accuracy
