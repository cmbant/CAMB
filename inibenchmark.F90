    ...
    !     This is a sample driver routine that reads a set of parameters and
    !     runs CAMB several times to benchmark and profile the application.
    !     No output will be generated but the execution time
    !
    !     Based on inidriver.F90 and developed by Marco Raveri (mraveri@sissa.it)
    ...
    ! read from command line the number of times that the command is executed
