...
\begin{equation}
  ...
  \right],
\end{equation}
with \(p(l)=0.70\) for \(l<500\) and \(p(l)=0.14\) for \(l\ge500\).  This is a
smooth replacement for the old \(l\ge500,\nu/l\ge0.12\) corner; raw open-space
...
Low-order or low-\(\alpha\) fallback & \code{phi_recurs} & exact recurrence is safer. \\
\bottomrule
\end{tabularx}
\end{center}
