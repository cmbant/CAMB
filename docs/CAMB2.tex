...
are substantially smaller. We also describe the convention dependence of the nominally linear matter power spectrum
when a homogeneous calculation attempts to represent nonlinear reionization.
Essentially all
of the new algorithms and code were developed with LLMs/AI agents under human
supervision. This development also illustrates the use of use of \emph{custom-precision} numerical methods:
optimized algorithms calibrated to the accuracy required by the physical problem, rather than to
the fixed precision of general-purpose libraries.
\end{abstract}
