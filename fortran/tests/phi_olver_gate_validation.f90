...
write(*, '(a)') "label region L K nu alpha selected repeats phi_olver_cpu/eval phi_recurs_cpu/eval phi_olver_wall/eval phi_recurs_wall/eval ratio_cpu ratio_wall"
