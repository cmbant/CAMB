    ...
    class is (TSecondOrderPK)
        associate(this_r => this%r, this_k => this%k)
            ...
            if (k > this%min_store .and. k < this%max_k) then
                ...
                else if (this%term == term_vv) then
                    int = ((this_r - x*(7 - 6*this_r*x))/(1 + this_r*(this_r - 2*x)))**2
                else if (this%term == term_dv) then
        ...
        do it = 1, CAMB_Pk%num_z
            ...
            do i = 1, CAMB_Pk%num_k
                ...
                if (this%k > this%Min_kh_nonlinear) then
                    ...
                    t1 = &
                        Integrate_Romberg(this, Integrand, this%epsilon, 1 - this%epsilon, rtol*this%PK, abs_tol=.true.)
                    ...
                    t3 = Integrate_Romberg(this, Integrand, 1 - this%epsilon, 1 + this%epsilon, rtol*this%PK, &
                        abs_tol=.true.)
                    ! sc = this_K**3/(2*pi**2)
