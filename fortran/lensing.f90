    ...
    else if (method == lensing_method_flat_corr) then
        call CorrFuncFlatSky(State)
    else if (method == lensing_method_harmonic) then
                ...
                if (DoPol) then
                    ...
                    do l2 = almin, min(maxl, al + l1)
                        ...
                        if (mod(k, 2) == 0) then
                            ...
                            hk = k/2
                            F = lnfa(hk) - lnfa(hk - al) - lnfa(hk - l1) - lnfa(hk - l2) + &
                                (lnfa(k - 2*al) + lnfa(k - 2*l1) + lnfa(k - 2*l2) - lnfa(k + 1))/2
                    ...
                    do l2 = almin + mod(al + l1 + almin, 2), min(maxl, al + l1), 2
                        ...
                        fct = g1*g2l*g2l1*roots(l2)/2
                        expF = exp(2*(lnfa(hk) - lnfa(hk - al) - lnfa(hk - l1) - lnfa(hk - l2)) + lnfa(k - 2*al) + &
                            lnfa(k - 2*l1) + lnfa(k - 2*l2) - lnfa(k + 1))
