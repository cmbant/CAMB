    ...
    def run(self):
        ...
        if is_windows:
            ...
            if not ok:
                ...
                SOURCES = " constants.f90 classes.f90 MathUtils.f90 subroutines.f90 recfast.f90 reionization.f90 DarkEnergyInterface.f90  modules.f90" \
                          " bessels.f90 equations.f90 power_tilt.f90 DarkEnergyFluid.f90 DarkEnergyPPF.f90 massive_neutrinos.f90 halofit_ppf.f90 lensing.f90 SeparableBispectrum.f90" \
