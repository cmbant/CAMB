...
environment first, then in a workspace `.venv`, then on your `PATH`. This keeps the same checkout working on a Linux
devcontainer and a Windows host without rewriting the hook each time you switch environments.
